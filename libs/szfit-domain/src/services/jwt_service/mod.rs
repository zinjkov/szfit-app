...
use crate::services::jwt_service::implementation::jwt_service::{AccessTokenExpTime, JwtService, RefreshTokenExpTime};
pub use auth_claims::*;
use chrono::Duration;
...
pub fn register_in_catalog(builder: &mut CatalogBuilder) {
    ...
    builder.add::<JwtAuthenticator>()
        .bind::<dyn IJwtAuthenticator, JwtAuthenticator>();
    builder.add::<JwtService>()
        .bind::<dyn IJwtService, JwtService>();
}